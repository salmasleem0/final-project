        ...
        <div class="products-area-wrapper tableView">
            <div class="products-header">
                <div class="product-cell image">
                    <span>ID</span>
                    <button class="sort-button" aria-label="Sort ID">
            ...
            <div class="products-row">
                <div class="product-cell category">
                    <span class="cell-label">ID:</span>{{$user->id}}
                </div>
                <div class="product-cell category">
                ...
                <div class="product-cell category">
                    <span class="cell-label">User Type:</span>{{$user->user_type}}
                </div>
                <div class="product-cell category">
                    <span class="cell-label">Address</span>{{$user->address}}
                </div>
                <div class="product-cell category">
                    <span class="cell-label">phone-num</span>{{$user->phone_num}}
                </div>
                <div class="product-cell category">
                    <span class="cell-label">created at</span>{{$user->created_at}}
                </div>
              
 
                <div class="product-cell action">
                    <span class="cell-label">Actions:</span>
                    <button type="button" class="btn btn-success" aria-label="View User">
